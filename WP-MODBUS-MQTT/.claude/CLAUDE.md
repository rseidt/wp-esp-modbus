...
> **Wiederaufnahme** nur mit gefixtem From-Source-Flashtreiber (Kandidat: `CONFIG_SPI_FLASH_ROM_IMPL=y` → ROM-Implementierung, Cache-sicher) und **separat ausserhalb der verbauten WP** testen, nicht am Produktivgerät.
